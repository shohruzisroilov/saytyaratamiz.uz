...
export const metadata: Metadata = {
  ...
  description:
    "SaytYaratamiz.uz bilan bog'laning. Bepul konsultatsiya oling. Tel: +998 90 123 45 67. Telegram, Instagram orqali ham murojaat qilishingiz mumkin.",
          ...
          <div className="grid lg:grid-cols-5 gap-10 max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="flex items-start gap-3 p-4 rounded-[14px] bg-green-500/5 border border-green-500/15">
                <MessageCircle className="w-4.5 h-4.5 text-green-500 shrink-0 mt-0.5" />
                <div>
