...
export default function NotFound() {
  return (
    <main className="min-h-dvh flex items-center justify-center bg-background px-5">
      <div className="text-center max-w-lg space-y-6">
        ...
        <div className="space-y-3">
          <h1 className="font-display text-2xl sm:text-3xl font-bold text-foreground tracking-[-0.02em]">
            Sahifa Topilmadi
          </h1>
        ...
        <nav aria-label="Sahifaga qaytish" className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/xizmatlar"
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-md border border-border text-foreground font-semibold text-sm hover:border-primary/40 hover:text-primary transition-all duration-200"
          >
