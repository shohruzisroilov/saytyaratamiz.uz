  ...
  return (
    <>
        ...
        <div className="container mx-auto px-5 sm:px-8 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div className="space-y-6">
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground tracking-[-0.02em] leading-tight">
                Yuqori Konversiyali{" "}
              ...
              <div className="grid grid-cols-3 gap-4 py-2">
                {[
                  ...
                  <div key={s.label} className="text-center p-3 rounded-md bg-muted/40 border border-border">
            ...
            <div className="relative hidden lg:flex items-center justify-center">
              <div className="w-full max-w-[340px] rounded-2xl border border-border bg-card shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden">
                ...
                <div className="p-6 space-y-4 bg-white">
                  <div className="w-3/4 h-6 bg-foreground/8 rounded-sm" />
                  <div className="w-1/2 h-6 bg-primary/20 rounded-sm" />
                  <div className="space-y-1.5">
                    <div className="w-full h-2.5 bg-muted rounded" />
                    <div className="w-5/6 h-2.5 bg-muted rounded" />
                  </div>
                  <div className="w-32 h-10 bg-primary rounded" />
              ...
              {/* Badge */}
              <div className="absolute -top-4 -right-4 px-4 py-2.5 rounded-md bg-white border border-border shadow-[0_8px_24px_rgba(0,0,0,0.1)]">
      ...
      <section className="py-16 bg-surface" aria-labelledby="usecases-heading">
        <div className="container mx-auto px-5 sm:px-8 lg:px-10">
          <h2 id="usecases-heading" className="font-display text-2xl sm:text-3xl font-bold text-foreground tracking-[-0.02em] text-center mb-10">
            Kim uchun kerak?
          </h2>
