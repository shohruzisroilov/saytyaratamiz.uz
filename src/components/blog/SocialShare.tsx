    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-row lg:flex-col gap-2">
        ...
        <a
          ...
          className="w-10 h-10 rounded-md border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-white hover:bg-[#229ED9] hover:border-[#229ED9] transition-all duration-300 group"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-md border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all duration-300"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-md border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-white hover:bg-black hover:border-black transition-all duration-300"
          title="Twitter (X) orqali ulashish"
          aria-label="Twitter (X) orqali ulashish"
        >
        ...
        <button type="button"
          onClick={handleCopy}
          className={cn(
            "w-10 h-10 rounded-md border flex items-center justify-center transition-all duration-300 relative",
            copied
